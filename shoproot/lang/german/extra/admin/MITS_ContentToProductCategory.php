...
defined('MODULE_CATEGORIES_MITS_CONTENTTOPRODCAT_TITLE') or define('MODULE_CATEGORIES_MITS_CONTENTTOPRODCAT_TITLE', 'MITS Content f&uuml;r Artikel und Kategorien  <span style="white-space:nowrap;">&copy; by <span style="padding:2px;background:#ffe;color:#6a9;font-weight:bold;">Hetfield (MerZ IT-SerVice)</span></span>');
defined('MODULE_CATEGORIES_MITS_CONTENTTOPRODCAT_DESCRIPTION') or define('MODULE_CATEGORIES_MITS_CONTENTTOPRODCAT_DESCRIPTION', '
...
defined('MODULE_CATEGORIES_MITS_CONTENTTOPRODCAT_STATUS_TITLE') or define('MODULE_CATEGORIES_MITS_CONTENTTOPRODCAT_STATUS_TITLE', 'Modul aktivieren?');
defined('MODULE_CATEGORIES_MITS_CONTENTTOPRODCAT_STATUS_DESC') or define('MODULE_CATEGORIES_MITS_CONTENTTOPRODCAT_STATUS_DESC', 'Das Modul MITS Content f&uuml;r Artikel und Kategorien aktivieren');

defined('MITS_CONTENTFORPRODUCTSANDCATEGORIES_TEXT') or define('MITS_CONTENTFORPRODUCTSANDCATEGORIES_TEXT', 'Content-Seite Nr.');
defined('MITS_CONTENTFORPRODUCTSANDCATEGORIES_TOOLTIP') or define('MITS_CONTENTFORPRODUCTSANDCATEGORIES_TOOLTIP', 'Im Template verf&uuml;gbare Smarty-Variablen:<br>');

defined('MODULE_PRODUCT_MITS_CONTENTFORPRODUCTSLISTING_TITLE') or define('MODULE_PRODUCT_MITS_CONTENTFORPRODUCTSLISTING_TITLE', 'MITS Content f&uuml;r Artikel und Kategorien  <span style="white-space:nowrap;">&copy; by <span style="padding:2px;background:#ffe;color:#6a9;font-weight:bold;">Hetfield (MerZ IT-SerVice)</span></span>');
defined('MODULE_PRODUCT_MITS_CONTENTFORPRODUCTSLISTING_DESCRIPTION') or define('MODULE_PRODUCT_MITS_CONTENTFORPRODUCTSLISTING_DESCRIPTION', '
    <a href="https://www.merz-it-service.de/" target="_blank">
      <img src="' . (ENABLE_SSL === true ? HTTPS_SERVER : HTTP_SERVER) . DIR_WS_CATALOG . DIR_WS_IMAGES . 'merz-it-service.png" border="0" alt="MerZ IT-SerVice" style="display:block;max-width:100%;height:auto;">
    </a><br>
...
defined('MODULE_PRODUCT_MITS_CONTENTFORPRODUCTSLISTING_STATUS_TITLE') or define('MODULE_PRODUCT_MITS_CONTENTFORPRODUCTSLISTING_STATUS_TITLE', 'Modul aktivieren?');
defined('MODULE_PRODUCT_MITS_CONTENTFORPRODUCTSLISTING_STATUS_DESC') or define('MODULE_PRODUCT_MITS_CONTENTFORPRODUCTSLISTING_STATUS_DESC', 'Das Modul MITS Content f&uuml;r Artikel und Kategorien aktivieren');
