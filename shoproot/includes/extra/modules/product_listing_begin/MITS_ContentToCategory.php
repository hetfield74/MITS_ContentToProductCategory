    ...
    if (is_array($mits_contentsites) && sizeof($mits_contentsites) > 0) {
        ...
        foreach ($mits_contentsites as $mits_prod_content) {
            ...
            if ($mits_content_counter == 1) {
                ...
                $module_smarty->assign('MITS_CONTENT_TEXT', $content_data['content_text']);
            }
            ...
            $module_smarty->assign('MITS_CONTENT_TEXT_' . $mits_content_counter, $content_data['content_text']);
